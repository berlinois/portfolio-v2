...
export class ExperiencesEnglish implements ExperiencesList {
        ...
        this.experiencesList = [
            {
                ...
                paragraphList: [
                    {
                        title: `Development of a Web portal sianamaste.fr :`,
                        listText: [
                            `Collecte of business requirements and creation of mockups`,
                            `Search for the graphic charter`,
